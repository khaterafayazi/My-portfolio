        ...
        <div>
            ...
            <div className=" border border-purple-600 bg-[#15152D] rounded-2xl p-2 ">
                ...
                <div className="flex gap-6">
                    <a href="" target="blenk" rel="noopener noreferrer">
                    <Mail className="text-white" size={40}/>
                    </a>
                    <a href="https://www.linkedin.com/in/khatera-fayazi-4482003a7/" target="_blenk" rel="noopener noreferrer">
           ...
           <form ref = {form} onSubmit = {sendEmail}>
            ...
            <input type="text" placeholder="type your name" name="name" className=" w-3/4 backdrop-blur-md border border-white/20"/>
            </div>
            <div className="mb-3">
            <label>Your Email :  </label>
            <input type="email" placeholder="type your email" name="email" className="border border-wite w-3/4 backdrop-blur-md border border-white/20"/>
            </div>
            <div className="mb-3">
            <label>Subject :  </label>
            <input type="text" placeholder="subjact" name="title" className="border border-white w-3/4 backdrop-blur-md border border-white/20"/>
            </div>
            <div className="mb-2">
                <div>
            ...
            <button type="submit" className="w-3/4 bg-gradient-to-l from-[#0D0A1F]via-purple-400 to-blue-500 bg-purple-600 rounded-xl p-2 hover:scale-105 transition-transform mt-4 ">Send Message</button>
            </div>
           </form>
           </div>
           </div>
